...
export function applyArchetypeDefaults(resources: ResourceSet, archetype: AgentArchetype): void {
  switch (archetype) {
    case AgentArchetype.StaticTile: {
    ...
    default: {
      // Mobile agents receive finite non-zero defaults (tunable for future balancing).
...
export class SelfState {
  ...
  level: i32 = 0;
  identity: i32 = 0;
  archetype: AgentArchetype = AgentArchetype.Mobile;
...
export class AgentContext {
  ...
  // Read-only snapshot updated by stepObservation
