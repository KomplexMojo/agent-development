...
// REQ:P4-F04_1 — unconstrained movement (with stamina costs per P4-F04_3)
// Applies a raw delta to the authoritative position when sufficient stamina exists.
export function moveBy(ctx: AgentContext, dx: i32, dy: i32): bool {
...
export function moveLevelBy(ctx: AgentContext, dz: i32): bool {
  if (dz == 0) return true;
